...
/***/ "../../../../../src/app/users/users-component/users.component.css":
...
/***/ "../../../../../src/app/users/users-component/users.component.html":
...
/***/ "../../../../../src/app/users/users-component/users.component.ts":
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(usersService, fb) {
        ...
        this.fg = fb.group({
            ...
            address: fb.group({
                street: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required],
                city: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required],
                suite: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required]
            })
        });
    }
    /* Getting added user data and submit it if it's valid */
    UsersComponent.prototype.addUser = function ($data) {
        if (this.fg.valid) {
    ...
    UsersComponent.prototype.ngOnInit = function () {
        var _this = this;
        /* Getting users data */
        this.subscription = this.usersService.getAllUsers().subscribe(function (res) {
            _this.users = res;
            /* Set next user id */
            _this.nextUserId = _this.users[_this.users.length - 1]['id'] + 1;
        });
    };
    ...
    UsersComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-users',
            template: __webpack_require__("../../../../../src/app/users/users-component/users.component.html"),
            styles: [__webpack_require__("../../../../../src/app/users/users-component/users.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__core_services_http_users_service__["a" /* UsersService */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */]])
    ], UsersComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__users_component_users_component__ = __webpack_require__("../../../../../src/app/users/users-component/users.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__users_component_users_component__["a" /* UsersComponent */]
    }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__users_component_users_component__ = __webpack_require__("../../../../../src/app/users/users-component/users.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_services_http_users_service__ = __webpack_require__("../../../../../src/app/core/services/http/users.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsersModule = /** @class */ (function () {
    ...
    UsersModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__core_services_http_users_service__["a" /* UsersService */]],
            declarations: [__WEBPACK_IMPORTED_MODULE_4__users_component_users_component__["a" /* UsersComponent */]]
        })
    ], UsersModule);
    return UsersModule;
}());
